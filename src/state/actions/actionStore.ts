...
export interface FETCH_BY_ID_STORE_ACTION {
        type: STORE_ActionType.FETCH_BY_ID_STORE;
        payload: STORE_STATE[];
      }

export type ACTION_STORE  = ADD_STORE_ACTION | UPDATE_STORE_ACTION  | DELETE_STORE_ACTION  | VIEW_STORE_ACTION  | SEARCH_STORE_ACTION | FETCH_BY_ID_STORE_ACTION ;